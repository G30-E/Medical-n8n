...
public final class FragmentSettingsBinding implements ViewBinding {
  ...
  private FragmentSettingsBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnLogout,
      @NonNull Button btnShareApp, @NonNull Button btnVolverMenu,
  ...
  public static FragmentSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnShareApp;
      Button btnShareApp = ViewBindings.findChildViewById(rootView, id);
      if (btnShareApp == null) {
        break missingId;
      }
      ...
      return new FragmentSettingsBinding((LinearLayout) rootView, btnLogout, btnShareApp,
          btnVolverMenu, switchDarkMode);
    }

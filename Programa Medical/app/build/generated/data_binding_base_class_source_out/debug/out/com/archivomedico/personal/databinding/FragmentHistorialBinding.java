...
public final class FragmentHistorialBinding implements ViewBinding {
  ...
  @NonNull
  public final ListView listNotas;

  @NonNull
  public final TextView tvEmpty;

  private FragmentHistorialBinding(@NonNull RelativeLayout rootView, @NonNull Button btnVolverMenu,
      @NonNull FloatingActionButton fabAddNote, @NonNull ListView listNotas,
  ...
  public static FragmentHistorialBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.listNotas;
      ListView listNotas = ViewBindings.findChildViewById(rootView, id);
      if (listNotas == null) {
        break missingId;
      }
      ...
      return new FragmentHistorialBinding((RelativeLayout) rootView, btnVolverMenu, fabAddNote,
          listNotas, tvEmpty);
    }
